...
int main()
{
  ...
  //addVectorsInto<<<numberOfBlocks, threadsPerBlock, 0, stream2>>>(c+N/3,a+N/3, b+N/3, N/3);
  //addVectorsInto<<<numberOfBlocks, threadsPerBlock, 0, stream3>>>(c+2*N/3, a+2*N/3, b+2*N/3, N/3); 
